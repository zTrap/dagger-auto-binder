...
import ru.ztrap.tools.autobinder.processor.internal.createGeneratedAnnotation
...
class AutoBinderProcessor : AbstractProcessor() {
    ...
    private fun AutoBinderModuleElements.toAutoBinderModuleGenerator(
        ...
        return AutoBinderModuleGenerator(public, moduleName, roundEnvironment, generatedAnnotation)
    }
    ...
    private fun writeAutoBinderModule(
        ...
        JavaFile.builder(moduleGenerator.generatedType.packageName(), generatedTypeSpec).build().writeTo(filer)
    }
