...
/**
 * @author pa.gulko zTrap (31.10.2019)
 */
...
class AutoBinderProcessor : AbstractProcessor() {
    ...
    override fun process(annotations: Set<TypeElement>, roundEnv: RoundEnvironment): Boolean {
        ...
        FileSpec.builder(packageName, MODULE_NAME)
            .addComment("Generated by @AutoBind. Do not modify!")
            .addType(autoBinderModule.addGeneratedAnnotation().build())
            .build()
    ...
    private fun TypeSpec.Builder.addGeneratedAnnotation(): TypeSpec.Builder {
        val generatedType = processingEnv.elementUtils.getTypeElement("javax.annotation.processing.Generated")
            ?: processingEnv.elementUtils.getTypeElement("javax.annotation.Generated")
            ?: return this
        addAnnotation(
            AnnotationSpec.builder(generatedType.asClassName())
                .addMember("value = [%S]", this@AutoBinderProcessor.javaClass.name)
